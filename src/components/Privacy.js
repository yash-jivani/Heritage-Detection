        ...
        <div className='py-12'>
            <div className='support max-w-[1250px] mx-auto px-4 lg-edit-sec'>
                ...
                <div className='support-data lg-edit-data lg:pl-7'>
                    <h1 className='font-bold text-xl mb-2 text-center mt-6 lg:m-0 md:text-left'>Privacy</h1>
                    <h5>It doesn't have any annoying ads so that you can predict Heritage place without any kind of disturbance or hesitation..</h5>
                    <h1 className='font-bold text-xl my-2'>Privacy-First Features.</h1>
                    <ul>
